...
Let's start by loading playlists from the recent [Grammy](https://open.spotify.com/playlist/37i9dQZF1DX5FyxM4IcLn6) and [Edison](https://open.spotify.com/playlist/3yvFKwXXX7uEFV36FYcrgm) awards. Save the Grammys as `grammy` and the Edisons as `edison`.
