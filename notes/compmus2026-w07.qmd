...
The first step to working with data is to choose a playlist on Spotify and add it to your personal playlist collection. Let's check into Soundway Records's ['Soundway Records Selects'](https://canvas.uva.nl/courses/58586/pages/sources-of-sometimes-good-data-visualisations?module_item_id=2714712). Open the link and add it to your Spotify library.
...
Let's start by loading playlists from the recent [Grammy](https://open.spotify.com/playlist/37i9dQZF1DX5FyxM4IcLn6?si=8-3Qva-mRbqyEBbhRn6sTQ) and [Edison](https://open.spotify.com/playlist/37i9dQZF1DX5FyxM4IcLn6?si=8-3Qva-mRbqyEBbhRn6sTQ) awards. Save the Grammys as `grammy` and the Edisons as `edison`.
