...
One of the `compmus` helper functions, `compmus_wrangle_chroma()`, converts the data frames we import from Sonic Visualiser to a mroe useful format for analysis in this course.
