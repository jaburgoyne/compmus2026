...
The following code fetches the analysis for Zager and Evans's 'In the Year 2525' (1969). You can download the chroma features for this track [here]("../dat/year-2525-pitches.csv").
